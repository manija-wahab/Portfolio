  ...
  await knex('aboutMe').insert([
    {
      ...
      likes: JSON.stringify(['cats', 'video games', 'reading books']),
      ...
      origin_story:
        'I hate my real name Manija, so my family calls me Nora, but no one else ever said it right :C So my friends call me Nora :D But this became a problem as everyone started to call me... Dora the Explorer. But I embraced it!! I started calling myself Nora the Explorer, and once I began coding, I upgraded to "Nora the Internet Explorer." Hah! Get it? Like the web browser! Okay, sorry, that was cringe. Now, I wander the digital realm, solving bugs and pushing code. Thank you for reading C:',
    },
  ])
}
